    ...
    <div className="px-[var(--sm-px)] md:px-[var(--md-px)] lg:px-[var(--lg-px)]">
      ...
      >
        ...
        <section className="w-full flex flex-col items-start">
          <SectionHeading
            params={{
              content: t("submitAssignment:mainPage.title"),
            }}
          />
          <SectionDescription
            params={{
              content: t("submitAssignment:mainPage.description"),
              alignment: "text-left",
              className: "mb-16",
            }}
          />
          <div className="w-full flex flex-row gap-10">
            <SubmitAssignmentCard
              params={{
                ...
                header: t("submitAssignment:mainPage.blocks.file.header"),
                description: t(
                  "submitAssignment:mainPage.blocks.file.description"
                ),
              }}
            />
            ...
            <SubmitAssignmentCard
              params={{
                ...
                header: t("submitAssignment:mainPage.blocks.text.header"),
                description: t(
                  "submitAssignment:mainPage.blocks.text.description"
                ),
              }}
            />
          </div>
